...
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		com.avaya.sce.runtime.Submit submit = new com.avaya.sce.runtime.Submit("PrimerMenu");
		return ( submit );
	}
	/**
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.C_VAR_CONTADORES_FIELD_CONTADOR_MENU_1,
			IProjectVariables.C_VAR_CONTADORES_FIELD_CONTADOR_MENU_2 };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.C_VAR_CONTADORES, variableFields, new String[] {"0", "0"}, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.C_VAR_MAX_REP_FIELD_MAXIMAS_REPETICIONES_MENU_1,
			IProjectVariables.C_VAR_MAX_REP_FIELD_MAXIMAS_REPETICIONES_MENU_2 };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.C_VAR_MAX_REP, variableFields, new String[] {"3", "3"}, null, session, false, false );
		session.putVariable(variable);

		variableFields = new String[] {
			IProjectVariables.PRIMER_MENU_FIELD_CONFIDENCE,
			IProjectVariables.PRIMER_MENU_FIELD_INPUTMODE,
			IProjectVariables.PRIMER_MENU_FIELD_INTERPRETATION,
			IProjectVariables.PRIMER_MENU_FIELD_NOINPUTCOUNT,
			IProjectVariables.PRIMER_MENU_FIELD_NOMATCHCOUNT,
			IProjectVariables.PRIMER_MENU_FIELD_UTTERANCE,
			IProjectVariables.PRIMER_MENU_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.PRIMER_MENU, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.SEGUNDO_MENU_FIELD_CONFIDENCE,
			IProjectVariables.SEGUNDO_MENU_FIELD_INPUTMODE,
			IProjectVariables.SEGUNDO_MENU_FIELD_INTERPRETATION,
			IProjectVariables.SEGUNDO_MENU_FIELD_NOINPUTCOUNT,
			IProjectVariables.SEGUNDO_MENU_FIELD_NOMATCHCOUNT,
			IProjectVariables.SEGUNDO_MENU_FIELD_UTTERANCE,
			IProjectVariables.SEGUNDO_MENU_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.SEGUNDO_MENU, variableFields, null, session, false, false );
		session.putVariable(variable);
