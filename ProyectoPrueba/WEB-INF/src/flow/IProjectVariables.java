...
public interface IProjectVariables {
	...
	public static final String C_VAR_CONTADORES = "cVarContadores";
	public static final String VDU__CACHE = "vdu_cache";
	public static final String REDIRECTINFO = "redirectinfo";
	public static final String SESSION = "session";
	public static final String C_VAR_MAX_REP = "cVarMaxRep";
	public static final String PRIMER_MENU = "PrimerMenu";
	public static final String DD_LAST_EXCEPTION = "ddLastException";
	public static final String TIME = "time";
	public static final String SEGUNDO_MENU = "SegundoMenu";
	...
	public static final String C_VAR_CONTADORES_FIELD_CONTADOR_MENU_1 = "contadorMenu1";
	public static final String C_VAR_CONTADORES_FIELD_CONTADOR_MENU_2 = "contadorMenu2";
	...
	public static final String C_VAR_MAX_REP_FIELD_MAXIMAS_REPETICIONES_MENU_1 = "maximasRepeticionesMenu1";
	public static final String C_VAR_MAX_REP_FIELD_MAXIMAS_REPETICIONES_MENU_2 = "maximasRepeticionesMenu2";
	public static final String PRIMER_MENU_FIELD_CONFIDENCE = "confidence";
	public static final String PRIMER_MENU_FIELD_INPUTMODE = "inputmode";
	public static final String PRIMER_MENU_FIELD_INTERPRETATION = "interpretation";
	public static final String PRIMER_MENU_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String PRIMER_MENU_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String PRIMER_MENU_FIELD_UTTERANCE = "utterance";
	public static final String PRIMER_MENU_FIELD_VALUE = "value";
	...
	public static final String SEGUNDO_MENU_FIELD_CONFIDENCE = "confidence";
	public static final String SEGUNDO_MENU_FIELD_INPUTMODE = "inputmode";
	public static final String SEGUNDO_MENU_FIELD_INTERPRETATION = "interpretation";
	public static final String SEGUNDO_MENU_FIELD_NOINPUTCOUNT = "noinputcount";
	public static final String SEGUNDO_MENU_FIELD_NOMATCHCOUNT = "nomatchcount";
	public static final String SEGUNDO_MENU_FIELD_UTTERANCE = "utterance";
	public static final String SEGUNDO_MENU_FIELD_VALUE = "value";
